...
import com.example.my.exception.NoMatchingDataException;
...
public class JwtAuthorizationFilter extends BasicAuthenticationFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		System.out.println("jwtHeader!!!11 : " + jwtHeader);
		...
		User userEntity = userRepository.findEntityGraphRoleTypeByUserId(userId).orElseThrow(new Supplier<NoMatchingDataException>() {
			@Override
